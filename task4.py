...
expanses = float(input("Введите издержки фирмы: "))
if profit > expanses:
    difference = profit - expanses
    print(f"Финансовый результат = прибыль.Ее величина :{difference}")
    print(f"Рентабельность выручки составила {difference / expanses:.2f}")
    workers = int(input("Введите количество сотрудников фирмы "))
    print(f"прибыль в расчете на одного сотрудника: {difference/ workers:.2f}")
elif profit == expanses:
